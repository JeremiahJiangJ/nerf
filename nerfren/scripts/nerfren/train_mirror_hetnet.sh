...
python train.py --name $dataset \
    --dataset_mode rffr --dataset_root ../datasets/${dataset} --img_wh 648 432 \
    --checkpoints_dir "./checkpoints/mirror_hetnet/" \
    --summary_dir "./runs/mirror_hetnet/" \
    ...
    --with_mask --lambda_beta_mask 0.1 --num_masks 30 \
