...
python train.py --name $dataset \
    ...
    --checkpoints_dir "./checkpoints/upmirror_hetnet_msd_cleaned/" \
    --summary_dir "./runs/upmirror_hetnet_msd_cleaned/" \
    ...
    --dir_pe_masking True --dir_pe_masking_start 10 --dir_pe_masking_end 20 \
    --with_mask --lambda_beta_mask 0.1 --num_masks 64 \
    --mask_gen "_hetnet_msd_cleaned" \
