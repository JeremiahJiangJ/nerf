...
python train.py --name $dataset \
    ...
    --checkpoints_dir "./checkpoints/upmirror_hetnet_msd_og/" \
    --summary_dir "./runs/upmirror_hetnet_msd_og/" \
    ...
    --with_mask --lambda_beta_mask 0.1 --num_masks 73 \
    --mask_gen "_hetnet_msd_og" \
