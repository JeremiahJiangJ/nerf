...
class Test(object):
    def __init__(self, Dataset, Network, path):
        ## dataset
        self.cfg = Dataset.Config(dataset='mirroripad', datapath=path, snapshot='./models/MSD-model-best/model-best', mode='test')
    ...
    def save(self):
        with torch.no_grad():
            ...
            for image, mask, shape, name in self.loader:
                ...
                save_path = f'../load/rffr/{self.dataset}/refl_masks'
                save_edge = f'../load/rffr/{self.dataset}/edge_maps' 
...
if __name__ == '__main__':
    ...
    for path in ['D:/HetNet/datasets/mirroripad']:
